...
module.exports.postNewForm = async (req, res) => {
    try {
        ...
        if (!title || !description || !price) {
            req.flash('error_msg', "All fields are required. Please provide valid data.");
        ...
        const newListing = new Listing({
            ...
            image: req.file ? {
                ...
                filename: "default",
                url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQz0P7Hc-KEeZ2S6WC_INBHTHqmC83WAPBI5A&s",
            },
        ...
        req.flash('error_msg', `Failed to create the listing: ${err.message}`);
